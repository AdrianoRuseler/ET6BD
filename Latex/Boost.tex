...
% Tabela com o ponto de operação do conversor
\input{Tables/Boost_steadystatesim.tex}
...
\input{Tables/Boost_step1malha.tex}



A \figref{fig:Boost1malha} apresenta o resultado da simulação da resposta ao degrau de referência de tensão....
...
% Tabela com a resposta ao degrau de referência
\input{Tables/Boost_step1malhaAmpOp.tex}


A \figref{fig:Boost1malhaAmpOp} apresenta o resultado da simulação da resposta ao degrau de referência de tensão....
...
% Tabela com a resposta ao degrau de referência
\input{Tables/Boost_step2malhas.tex}
...
A \figref{fig:Boost2malhas} apresenta o resultado da simulação da resposta ao degrau de referência de tensão....
