...
\hypersetup{
	...
	pdfkeywords={APS}{Overleaf}{ET6BD}{UTFPR}, 
...
\journalname{\small{ET6BD -- MODELAGEM E REGULAÇÃO DIGITAL DE CONVERSORES ESTÁTICOS}}
...
%\include{Buck} % Modelagem e controle do conversor Buck
%\include{Boost} % Modelagem e controle do conversor Boost
\include{Buck-Boost} % Modelagem e controle do conversor Buck-Boost
