...
\editorfootnote{Artigo compilado em {\today} às {\currenttime}h, referente a disciplina optativa de Modelagem e Regulação Digital de Conversores Estáticos -- ET6BD, ministrada pelo Prof. Adriano Ruseler, Dr. Eng.\\
	Repositório: \url{https://github.com/AdrianoRuseler/ET6BD} }
...
\input{Tables/Buck-Boost_parametros.tex}
...
\input{Tables/Buck-Boost_steadystate.tex}


A \tabref{tab:steadystatesim} apresenta uma comparação dos valores teóricos com os obtidos por simulação para o ponto de operação do conversor Buck--Boost.
\textcolor{red}{atualize os valores da tabela, arquivo \emph{Buck-Boost\_steadystatesim.tex} }

% Tabela com o ponto de operação do conversor
\input{Tables/Buck-Boost_steadystatesim.tex}

A \figref{fig:buck-boost-steadystate} apresenta a resposta da simulação do ponto de operação do conversor..  \textcolor{red}{compare se os valores simulados com os parâmetros de projeto...}
...
\input{Tables/Buck-Boost_step1malha.tex}


A \figref{fig:Buck-Boost1malha} apresenta o resultado da simulação da resposta ao degrau de referência de tensão....
...
% Tabela com a resposta ao degrau de referência
\input{Tables/Buck-Boost_step1malhaAmpOp.tex}



A \figref{fig:Buck-Boost1malhaAmpOp} apresenta o resultado da simulação da resposta ao degrau de referência de tensão....
...
% Tabela com a resposta ao degrau de referência
\input{Tables/Buck-Boost_step2malhas.tex}



A \figref{fig:Buck-BoostStepResponse2malhas} apresenta o resultado da simulação da resposta ao degrau de referência de tensão....
...
A \figref{fig:Buck-Boost2malhas} apresenta o resultado da simulação da resposta ao degrau de referência de tensão....
